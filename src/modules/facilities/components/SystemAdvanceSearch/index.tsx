...
// import { BROAD_CAST } from 'helper/consts';
// import {
//   changeSearchCondition,
//   getGetAllTopicTypeIDStart,
//   getGetAllUserStart,
//   getTimeConfigStart,
...
const SystemAdvanceSearch: React.FC<IProps> = () => {
  ...
  //   const {
  //     data: { userList, conditionSearch, timeConfigWeekList, topicTypeID },
  //   } = useSelector((state: RootState) => state.topic);

  //   const dispatch = useDispatch();
  //   const weekList = timeConfigWeekList?.TimeConfigWeekVmList;
